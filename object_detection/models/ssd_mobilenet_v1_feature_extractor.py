...
class SSDMobileNetV1RetinaNetDepthwiseFeatureExtractor(ssd_meta_arch.SSDFeatureExtractor):
  """SSD Feature Extractor using MobilenetV1 features."""
  ...
  def __init__(self,
    ...
    Args:
      ...
      reuse_weights: Whether to reuse variables. Default is None.
    """
    super(SSDMobileNetV1RetinaNetDepthwiseFeatureExtractor, self).__init__(
        depth_multiplier, min_depth, conv_hyperparams, reuse_weights)
