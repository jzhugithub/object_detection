...
def build(argscope_fn, box_predictor_config, is_training, num_classes):
  ...
  if  box_predictor_oneof == 'retinanet_box_predictor':
    ...
    box_predictor_object = box_predictor.RetinaNetBoxPredictor(
        ...
        use_depthwise_before_predictor=conv_box_predictor.use_depthwise_before_predictor,
  ...
  if  box_predictor_oneof == 'gradientconv_box_predictor':
    ...
    conv_hyperparams = argscope_fn(conv_box_predictor.conv_hyperparams,
                                   is_training)
    box_predictor_object = box_predictor.GradientConvolutionalBoxPredictor(
        is_training=is_training,
        num_classes=num_classes,
        conv_hyperparams=conv_hyperparams,
        min_depth=conv_box_predictor.min_depth,
  ...
  if  box_predictor_oneof == 'areaconv_box_predictor':
    conv_box_predictor = box_predictor_config.areaconv_box_predictor
    conv_hyperparams = argscope_fn(conv_box_predictor.conv_hyperparams,
                                   is_training)
    box_predictor_object = box_predictor.AreaConvolutionalBoxPredictor(
        is_training=is_training,
        num_classes=num_classes,
        conv_hyperparams=conv_hyperparams,
        min_depth=conv_box_predictor.min_depth,
