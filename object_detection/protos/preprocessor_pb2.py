...
_PREPROCESSINGSTEP = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='random_vertical_flip', full_name='object_detection.protos.PreprocessingStep.random_vertical_flip', index=23,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='random_rotate90', full_name='object_detection.protos.PreprocessingStep.random_rotate90', index=24,
...
_RANDOMROTATE90 = _descriptor.Descriptor(
  name='RandomRotate90',
  full_name='object_detection.protos.RandomRotate90',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
...
_PREPROCESSINGSTEP.fields_by_name['random_rotate90'].message_type = _RANDOMROTATE90
...
_PREPROCESSINGSTEP.oneofs_by_name['preprocessing_step'].fields.append(
  _PREPROCESSINGSTEP.fields_by_name['random_rotate90'])
_PREPROCESSINGSTEP.fields_by_name['random_rotate90'].containing_oneof = _PREPROCESSINGSTEP.oneofs_by_name['preprocessing_step']
...
DESCRIPTOR.message_types_by_name['RandomRotate90'] = _RANDOMROTATE90
...
RandomRotate90 = _reflection.GeneratedProtocolMessageType('RandomRotate90', (_message.Message,), dict(
  DESCRIPTOR = _RANDOMROTATE90,
  __module__ = 'object_detection.protos.preprocessor_pb2'
  # @@protoc_insertion_point(class_scope:object_detection.protos.RandomRotate90)
  ))
_sym_db.RegisterMessage(RandomRotate90)
