...
_CLASSIFICATIONLOSS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='weighted_focal', full_name='object_detection.protos.ClassificationLoss.weighted_focal', index=3,
...
_WEIGHTEDFOCALCLASSIFICATIONLOSS = _descriptor.Descriptor(
  name='WeightedFocalClassificationLoss',
  full_name='object_detection.protos.WeightedFocalClassificationLoss',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='alpha', full_name='object_detection.protos.WeightedFocalClassificationLoss.alpha', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='gamma', full_name='object_detection.protos.WeightedFocalClassificationLoss.gamma', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='anchorwise_output', full_name='object_detection.protos.WeightedFocalClassificationLoss.anchorwise_output', index=2,
...
_CLASSIFICATIONLOSS.fields_by_name['weighted_focal'].message_type = _WEIGHTEDFOCALCLASSIFICATIONLOSS
...
_CLASSIFICATIONLOSS.oneofs_by_name['classification_loss'].fields.append(
  _CLASSIFICATIONLOSS.fields_by_name['weighted_focal'])
_CLASSIFICATIONLOSS.fields_by_name['weighted_focal'].containing_oneof = _CLASSIFICATIONLOSS.oneofs_by_name['classification_loss']
...
DESCRIPTOR.message_types_by_name['WeightedFocalClassificationLoss'] = _WEIGHTEDFOCALCLASSIFICATIONLOSS
...
WeightedFocalClassificationLoss = _reflection.GeneratedProtocolMessageType('WeightedFocalClassificationLoss', (_message.Message,), dict(
  DESCRIPTOR = _WEIGHTEDFOCALCLASSIFICATIONLOSS,
  __module__ = 'object_detection.protos.losses_pb2'
  # @@protoc_insertion_point(class_scope:object_detection.protos.WeightedFocalClassificationLoss)
  ))
_sym_db.RegisterMessage(WeightedFocalClassificationLoss)
